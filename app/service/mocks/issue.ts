    ...
    history: [
      {
        name: '3.1 운동',
        description:
          '1919년 3월 1일을 기점으로 전국적으로 확산된 운동으로 한국 근대사에서 가장 큰 규모의 항일 독립운동이었습니다.',
      },
      {
        name: '조형균 외 10인 체포',
        description:
          '조형균 외 10인이 조선총독부에 독립청원서를 제출함과 동시에 체포됨.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '청산리 대첩',
        description:
          '김좌진, 홍범도 등이 이끈 독립군 연합부대가 일본군에 대승을 거둠.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '임시정부 처형사건',
        description:
          '함남 풍산군 안수면에 거주하는 김병선ㆍ염상한은 임시정부에 반항하는 자로서 정부원에게 총살됨.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '조선공산당 창당',
        description:
          '한국 최초의 공산주의 정당 결성. 일제의 탄압으로 1928년 해체.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '윤봉길 의사 의거',
        description:
          '상하이 훙커우 공원에서 일본 고위 관리들을 향해 폭탄을 투척.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '창씨개명 실시',
        description:
          '일제의 민족말살정책의 일환으로 한국인의 성과 이름을 일본식으로 개명 강요.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '6.25 전쟁 발발',
        description:
          '북한의 남침으로 한국전쟁 시작. 1953년 휴전 협정 체결까지 지속.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '4.19 혁명',
        description:
          '이승만 독재 정권에 반대하는 학생과 시민들의 대규모 시위. 이승만 대통령의 하야와 제1공화국의 몰락으로 이어짐.',
      },
      {
        name: '제2공화국 수립',
        description:
          '4.19 혁명 이후 장면 내각이 출범하며 의원내각제 형태의 제2공화국이 수립됨.',
      },
      {
        name: '3.15 부정선거',
        description:
    ...
    history: [
      {
        name: '5.16 군사정변',
        description:
          '박정희를 중심으로 한 군부 세력이 쿠데타를 일으켜 정권을 장악. 제2공화국의 종말과 군사 정부 수립.',
      },
    ],
  },
  {
    ...
    history: [
      {
        ...
        description:
          '박정희 정부의 경제 개발 정책 시작. 수출 주도형 경제 성장 전략 채택.',
      },
      {
        name: '통화개혁 실시',
        description:
          '화폐 가치를 10분의 1로 절하하는 통화개혁 실시. 경제 안정화 목적.',
      },
    ],
  },
  {
    ...
    history: [
      ...
      },
      {
        name: '한일회담 반대 시위',
        description:
          '한일 국교 정상화를 위한 회담에 반대하는 대규모 시위 발생.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '한일 기본조약 체결',
        description:
          '한국과 일본 간의 국교 정상화를 위한 조약 체결. 식민지배에 대한 배상금 성격의 경제협력 자금 도입.',
      },
      {
  ...
  },
  {
    ...
    history: [
      ...
      },
      {
        ...
        description:
          '중화학공업 육성과 사회간접자본 확충에 중점을 둔 경제 계획 시작.',
      },
    ],
  },
  {
    ...
    history: [
      ...
      },
      {
        name: '동백림 사건',
        description:
          '서독에서 활동하던 한국인들의 북한 접촉 사건. 대규모 간첩단 사건으로 확대.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '1.21 사태',
        description:
          '1968년 1월 21일 북한 민족보위성 정찰국 소속인 124군부대 무장 게릴라 31명이 청와대를 기습하기 위해 서울에 침투한 사건.',
      },
      {
        name: '푸에블로호 사건',
        description:
          '북한이 미 해군 정보함 푸에블로호를 나포한 사건. 한반도 긴장 고조.',
      },
    ],
  },
  {
    ...
    history: [
      ...
      },
      {
        name: '전태일 분신사건',
        description:
          '노동자의 열악한 근로조건 개선을 요구하며 전태일 분신. 노동운동의 기폭제.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    history: [
      ...
      },
      {
        name: '10월 유신',
        description:
          '박정희 대통령의 비상계엄 선포와 유신헌법 공포. 독재체제 강화.',
      },
    ],
  },
  {
    ...
    history: [
      ...
      },
      {
        name: '김대중 납치사건',
        description:
          '야당 정치인 김대중이 일본 도쿄에서 납치되어 서울로 강제 송환된 사건.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    history: [
      ...
      },
      {
        name: '판문점 도끼만행 사건',
        description:
          '판문점에서 북한군의 미군 장교 살해 사건. 한반도 긴장 고조.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    history: [
      ...
      },
      {
        ...
        description:
          '박정희 대통령, 통일주체국민회의에서 제9대 대통령으로 선출.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: 'YH무역 사건',
        description:
          'YH무역 여성 노동자들의 신민당사 농성 사건. 정부의 강경 진압.',
      },
      {
        name: '10.26 사태',
        description:
          '1979년 10월 26일 밤 7시 40분 경 서울 종로구 궁정동중앙정보부 안가에서 중앙정보부 부장 김재규가 대통령 박정희를 살해한 사건.',
      },
      {
        name: '12.12 군사반란',
  ...
  },
  {
    ...
    history: [
      ...
      },
      {
        name: '5.18 광주 민주화 운동',
        description:
          '전두환 신군부 세력에 반대하는 광주 시민들의 민주화 운동. 군부의 무력 진압.',
      },
      {
        name: '국가보위비상대책위원회 설치',
    ...
    history: [
      {
        name: '아웅산 테러 사건',
        description:
          '미얀마 아웅산 묘소에서 북한의 대남 테러. 한국 고위 관리 다수 사망.',
      },
      {
        name: 'KAL 007기 격추 사건',
    ...
    history: [
      {
        name: '86 아시안게임 개최',
        description:
          '서울에서 제10회 아시안게임 개최. 국제 스포츠 대회 주최국으로서의 위상 제고.',
      },
      {
        name: '5공 헌법 개정 논의 본격화',
        description:
          '여야 간 개헌 협상 시작. 대통령 직선제 도입 등 민주화 요구 고조.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '박종철 고문치사 사건',
        description:
          '서울대생 박종철의 경찰 고문으로 인한 사망 사건. 민주화 운동의 기폭제 역할.',
      },
      {
        name: '6월 민주 항쟁',
        description:
          '전국적인 민주화 시위로 직선제 개헌을 이끌어낸 대규모 민주화 운동.',
      },
      {
        name: '6.29 선언',
        description:
          '노태우 민정당 대표의 대통령 직선제 수용 및 민주화 조치 선언.',
      },
      {
    ...
    history: [
      {
        name: '3당 합당',
        description:
          '민주정의당, 통일민주당, 신민주공화당의 합당으로 민주자유당 출범.',
      },
      {
        name: '남북 유엔 동시 가입',
        description:
          '남북한 유엔 동시 가입 합의. 국제무대에서의 한반도 위상 변화.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    history: [
      ...
      },
      {
        name: '성수대교 붕괴 사건',
        description:
          '서울 성수대교 붕괴로 인한 대형 참사. 안전 불감증에 대한 경각심 고조.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '삼풍백화점 붕괴 사고',
        description:
          '서울 삼풍백화점 붕괴로 인한 대규모 인명 피해. 건설 안전에 대한 문제 제기.',
      },
      {
        name: '지방자치단체장 선거 실시',
        description:
          '최초의 전국 동시 지방선거 실시. 본격적인 지방자치 시대 개막.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '금강산 관광 시작',
        description:
          '최초의 민간인 대상 금강산 관광 시작. 남북 교류의 새로운 장 열림.',
      },
      {
        name: '제1차 연평해전',
    ...
    history: [
      {
        name: '제1차 남북정상회담',
        description:
          '김대중 대통령과 김정일 국방위원장 간 최초의 남북정상회담 개최.',
      },
      {
        name: '노벨평화상 수상',
  ...
  },
  {
    ...
    history: [
      ...
      },
      {
        name: '연평도 포격 사건',
        description:
          '북한의 연평도 포격으로 인한 민간인 사상자 발생. 한반도 긴장 고조.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '박근혜 정부 출범',
        description:
          "한국 최초의 여성 대통령인 박근혜 정부 출범. '창조경제'와 '국민행복' 강조.",
      },
      {
        name: '북한 3차 핵실험',
        description:
          '북한의 3차 핵실험 강행으로 한반도 긴장 고조 및 국제사회의 대북 제재 강화.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '세월호 침몰 사고',
        description:
          '진도 해상에서 여객선 세월호 침몰. 304명 사망·실종의 대형 참사 발생.',
      },
      {
        name: '국정원 대선 개입 의혹',
        description:
          '2012년 대선 당시 국가정보원의 선거 개입 의혹으로 정치적 갈등 심화.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '메르스(MERS) 사태',
        description:
          '중동호흡기증후군(MERS) 국내 유행으로 38명 사망, 사회·경제적 혼란 발생.',
      },
      {
        name: '한일 위안부 합의',
        description:
          '한국과 일본 정부 간 일본군 위안부 문제에 대한 합의 도출. 논란 지속.',
      },
    ],
  },
  {
    ...
    history: [
      {
        ...
        description:
          '최순실의 국정 개입 의혹 제기. 대규모 촛불집회 등 정국 혼란 지속.',
      },
      {
        name: '사드(THAAD) 배치 결정',
        description:
          '한미 양국, 주한미군 사드 배치 결정. 중국의 경제 보복 조치 시작.',
      },
    ],
  },
  {
    ...
    history: [
      ...
      },
      {
        ...
        description:
          '조기 대선에서 더불어민주당 문재인 후보 당선. 문재인 정부 출범.',
      },
      {
        name: '북한 6차 핵실험',
        description:
          '북한의 6차 핵실험으로 한반도 긴장 고조. 국제사회의 대북 제재 강화.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '평창 동계올림픽 개최',
        description:
          '평창에서 동계올림픽 개최. 남북 단일팀 구성 등 한반도 평화 분위기 조성.',
      },
      {
        name: '남북정상회담 개최',
        description:
          "판문점과 평양에서 남북정상회담 개최. '판문점 선언' 및 '9월 평양공동선언' 채택.",
      },
      {
        name: '첫 북미정상회담',
        description:
          '싱가포르에서 역사상 첫 북미정상회담 개최. 한반도 비핵화 논의.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '일본의 수출규제',
        description:
          '일본, 한국에 대한 수출규제 강화. 양국 관계 악화 및 경제적 영향.',
      },
      {
        name: '조국 법무부 장관 임명 논란',
        description:
          '조국 법무부 장관 임명을 둘러싼 정치적 갈등 및 대규모 집회 발생.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '코로나19 팬데믹',
        description:
          '코로나19의 전 세계적 확산. 사회적 거리두기 등 방역 조치 시행.',
      },
      {
        name: '제21대 국회의원 선거',
        description:
          '더불어민주당의 압승으로 끝난 총선. 180석 확보로 거대 여당 탄생.',
      },
    ],
  },
  {
    ...
    history: [
      {
        name: '코로나19 백신 접종 시작',
        description:
          '국내 코로나19 백신 접종 시작. 단계적 일상회복(위드 코로나) 추진.',
      },
      {
        name: '부동산 가격 급등',
        description:
          '수도권을 중심으로 한 부동산 가격 급등. 정부의 부동산 대책 논란.',
      },
    ],
  },
  {
    ...
    history: [
      ...
      },
      {
        name: '이태원 압사 참사',
        description:
          '서울 이태원에서 할로윈 축제 중 압사 사고 발생. 158명 사망.',
      },
      {
        name: '윤석열 정부 출범',
    ...
    history: [
      {
        name: '한일 관계 개선',
        description:
          '강제징용 배상 문제 해결 방안 발표. 한일 정상회담 개최 등 관계 개선 움직임.',
      },
      {
        name: '우크라이나 전쟁 지속',
        description:
          '러시아의 우크라이나 침공 장기화. 국제 정세 불안 및 경제적 영향 지속.',
      },
      {
        name: '2030 부산세계박람회 유치 실패',
        description:
          '2030년 세계박람회 개최지 선정에서 부산이 사우디아라비아 리야드에 패배.',
      },
    ],
  },
];
